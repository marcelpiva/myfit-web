          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center gap-3">
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                <Link href="/login" className="text-sm font-medium text-muted-foreground hover:text-foreground transition-colors whitespace-nowrap px-3 py-2">
                  {t.signIn}
                </Link>
              </motion.div>
              <motion.div whileHover={{ scale: 1.05, boxShadow: "0 10px 40px -10px rgba(37, 99, 235, 0.5)" }} whileTap={{ scale: 0.95 }}>
                <Link href="/register" className="text-sm font-semibold bg-primary text-primary-foreground px-4 py-2 hover:bg-primary/90 transition-all whitespace-nowrap">
                  {t.getStarted}
                </Link>
              </motion.div>
            </div>
